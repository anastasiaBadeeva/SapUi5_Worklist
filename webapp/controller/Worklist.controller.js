...
sap.ui.define([
	...
	"jetCources/ControlTaskBadeeva/model/formatter",
	"sap/ui/model/Filter",
	...
	return BaseController.extend("jetCources.ControlTaskBadeeva.controller.Worklist", {
		...
		onSearch: function(oEvent) {
			if (oEvent.getParameters().refreshButtonPressed) {
				...
				if (sQuery && sQuery.length > 0) {
					aTableSearchState = [new Filter("GroupText", FilterOperator.Contains, sQuery)];
				}
		...
		onPressMyID: function(oEvent) {
			var dialog = new sap.m.Dialog({
				title: "MyID",
				type: "Message",
				content: new sap.m.Text({
					text: "Badeeva Anastasia"
				}),
