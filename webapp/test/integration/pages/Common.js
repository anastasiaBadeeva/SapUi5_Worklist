sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("jetCources/ControlTaskBadeeva/app", ".html");
		...
		return Opa5.extend("jetCources.ControlTaskBadeeva.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["jetCources/ControlTaskBadeeva/localService/mockserver"], function (mockserver) {
