sap.ui.define([
		...
		"jetCources/ControlTaskBadeeva/test/integration/pages/shareOptions"
			...
			onTheWorklistPage : {
						...
						return this.waitFor(createWaitForItemAtPosition({
							...
							success : function (oTableItem) {
								...
								this.getContext().currentItem = {
									...
									id: oBindingContext.getProperty("GroupID"),
									name: oBindingContext.getProperty("GroupText")
								};
							}
						}));
					},
				...
				assertions: jQuery.extend({
					...
					theTableShouldHaveAllEntries : function () {
						...
						// retrieve all zjblessons_base_Groups to be able to check for the total amount
